    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-brand-black border border-gray-200 dark:border-neutral-800 w-full max-w-md p-8 rounded-lg shadow-2xl relative transition-colors duration-300">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-2">Acesso Restrito</h2>
          <p className="text-gray-500 dark:text-neutral-400 text-sm">Esta área é exclusiva para alunos da Formação.</p>
        </div>
